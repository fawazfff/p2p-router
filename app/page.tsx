...
export default function Home() {
  ...
  return (
    <main className="landing-page">
      ...
      <section className="landing-section shell choice-section"><div className="section-heading compact-heading"><h2>Quick match or complete route?</h2><p>Express works well for a straightforward match. P2P Router is built for amounts that may need more than one ad.</p></div><div className="choice-table"><div className="choice-labels" aria-hidden="true"><span>Binance P2P / Express</span><span>P2P Router</span></div><div><p>Moves you toward one available match</p><strong>Plans coverage for your entire amount</strong></div><div><p>You compare ad limits yourself</p><strong>Checks limits before a route qualifies</strong></div><div><p>One ad at a time</p><strong>Can combine up to three eligible merchants</strong></div><div><p>Best for a simple, direct purchase</p><strong>Best when route choice and full coverage matter</strong></div></div><p className="comparison-note">P2P Router does not replace Binance. It plans the route, then sends you to Binance to review and complete each order.</p></section>
